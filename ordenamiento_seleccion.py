...
lista=[1,9,12,2,6,4,7]
print(ord_seleccion(lista))

#En el caso del ordenamiento por selección, el invariante es que los elementos desde n+1 hasta el final
# de la lista están ordenados y son mayores que los elementos de 0 a n, es decir que ya están en su posición definitiva.